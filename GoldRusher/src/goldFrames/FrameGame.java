...
public class FrameGame extends ConfirmCloseFrame implements ActionListener, MoveResultListener {
    ...
    private static final String MESSAGE_DIE = "You Loose The Game!";
    private static final String MESSAGE_WIN = "You WIN! Your Score:";
    private static final String MESSAGE_SAVED_SUCCESS = "Game saved!";
    public static final String MESSAGE_SAVE_BEFORE_EXIT = "Do You want to save game?";
    ...
    private void initMap() {
        ...
        jPanel1.removeAll();
        System.out.println(mapLoader.getGameMap());
        jPanel1.add(mapLoader.getGameMap().getMap());
    ...
    private void gameFinished(String message) {
        stopGame();
        MessageManager.showInformMessages(null, message);
        closeFrame();
    }
    ...
    private void saveMap() {
        ...
        MessageManager.showInformMessages(this, MESSAGE_SAVED_SUCCESS);
    }
